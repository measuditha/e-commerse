...
<html lang="en">
	<head>
    	...
    	<title>Verdano - Online Shopping</title>
	...
	<?php
		...
		else
		{
			...
			$p=$_POST["password"];
			//echo $un."<br>".$p."<br>";
			$query = "SELECT * FROM userss WHERE username = '".$un."'";
    ...
    <body style="color: #f1f2f7">
    	...
    	<header>        
            <div class="logo"><a href="index.php"><img class="logoClass" src="store_images/logo.png"></a></div>
            <nav role = "header">
            	<ul>
    	...
    	<div class="catsearchDiv">
		    ...
		    <form class="search" method="POST" action="search.php">
		        <input type="text" name="sp" class="searchTerm" pattern="\S+.*"/ placeholder="Search in Verdano Store ...">
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel" style="width: 50%;margin-left: 25%;">
			    ...
			    <div class="carousel-inner">
			    	<div class="item active">
			    		<img src="store_images/img4.jpg" alt="Colombo" style="width:100%;">
				    ...
				    <div class="item">
				        <img src="store_images/img2.png" alt="Colombo" style="width:100%;">
				        <div class="carousel-caption">
				        	<h3>Colombo</h3>
				        	<p>Thank you, Colombo!</p>
				        </div>
				    </div>
				    <div class="item">
				        <img src="store_images/img5.png" alt="Colombo" style="width:100%;">
				        <div class="carousel-caption">
				        	<h3>Colombo</h3>
		...
		<footer class="ct-footer">
			<div class="container">
				<ul class="ct-footer-list text-center-sm">
				    ...
				    <li>
				        <h2 class="ct-footer-list-header">Verdano Store</h2>
				        <ul>
					        <li>
					            <a href="info.php">About Us</a>
					        </li>
			    ...
			    <div class="ct-footer-meta text-center-sm">
				    <div class="row">
				        <div class="col-sm-6 col-md-2">
				        	<img class="footerlogo" alt="logo" src="store_images/logoicon.png">
				        </div>
				        <div class="col-sm-6 col-md-3">
				          	<address>
				            	<span>Verdano Store Co.<br></span>
				            	Colombo
		  	...
		  	<div class="ct-footer-post">
		    	<div class="container">
		      		...
		      		<div class="inner-right">
		        		<p>Copyright © 2023 Verdano StoreCo.&nbsp;<a href="">Privacy Policy</a></p>
		        		<p><a class="ct-u-motive-color" href="" target="_blank">Web Design</a> by --- <a href="" target="_blank">verdano.com</a></p>
		      		</div>
		    	</div>
		  	</div>
		</footer>
