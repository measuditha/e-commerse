...
if ($_SESSION['logged_in'] == true) {
  if ($_SESSION["seller"] == false) {
    echo '<script>alert("You are not a Seller. Only sellers can view this page.");</script>';
  ...
  $query = "SELECT * FROM sellers WHERE usr_name = '".$un."'";
...
<header role="banner">
  <h1> <i style="color:#332F2F;" class="fas fa-user-lock"></i> Seller Portal</h1>
  <ul class="utilities">
    <br>
    <li class="users">
      <?php
...
<nav role='navigation'>
  <ul class="main">
    ...
    <button class="dropdown-order-btn" onclick="changeordercarret()">
      <font size="3"> <i class="fas fa-shipping-fast" style="margin-right: 8px;"></i>Orders</font><i class="fa fa-caret-down" id="ordercarret"></i>
    </button>
    ...
    <button class="dropdown-products-btn" onclick="changeproductcarret()">
      <font size="3"> <i class="fas fa-tshirt" style="margin-right: 8px;"></i> Products</font><i class="fa fa-caret-down" id="productscarret"></i>
    </button>
    ...
    <button class="dropdown-coupon-btn" onclick="changecouponcarret()">
      <font size="3"><i class="fas fa-money-check-alt" style="margin-right: 8px;"></i>Coupon</font><i class="fa fa-caret-down" id="couponcarret"></i>
    </button>
  ...
  <section class="panel important">
    <body onload="hidefield()">
      ...
      <div id="cp" style="display:none">
        <center>
          <form method="POST" action="updatesellerpassword.php">
